...
<div id="klcalImportRSS" class="kcal-import-container">
  ...
  <div class="kcal-import-actions">
    ...
    <div class="form-fields">
    <label for="kcal_importRSS_calendar"><?php __('Choose Calendar', 'kcal');?></label>
	...
	<div class="form-fields">
		<label for="rssImportTz"><?php _e('Set the timezone', 'kcal'); ?></label>
		<select name="kcal_import_events_timezone" id="rssImportTZ"><?php echo wp_timezone_choice( get_option('gmt_offset') ); ?></select>
	</div>
...
<div id="klcalImportICS" class="kcal-import-container">
  ...
  <div class="kcal-import-actions">
	...
	<div class="form-fields">
		<label for="icalImportTz"><?php _e('Set the timezone', 'kcal'); ?></label>
		<select name="kcal_import_events_timezone" id="icalImportTZ"><?php echo wp_timezone_choice( get_option('gmt_offset') ); ?></select>
	</div>
    <div class="form-buttons">
