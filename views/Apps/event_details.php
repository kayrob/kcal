<div class="quickview-popup" style="display:none" id="dlgEventDetails">
    <div class="animated fadeInUp">
        ...
        <input type="button" name="editEvent" id="editEvent" value="<?php _e('Edit', 'kcal');?>" class="button button-primary"/><input type="button" name="deleteEvent" id="deleteEvent" value="<?php _e('Delete','kcal');?>" class="button"/>
        </div>
    </div>
</div>